...
# My role
I designed and populated a knowledge-card-based repository where each card is a standalone source of truth with an explicit schema. The goal is to make the assistant’s behavior predictable, auditable, and easy to evaluate against a fixed question set.

# What I built
I built a set of knowledge cards derived from Piotr Synak’s CV, project descriptions, publication list, and xMBA certificate. The cards cover professional profile, AI projects, engineering practices, research contributions, certifications, leadership, and the system’s refusal policy.
